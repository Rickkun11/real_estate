        ...
        <> < div className = "" > <section className="text-gray-400 bg-slate-950 min-h-screen">
            <div className="flex flex-col mx-auto px-4 py-16 lg:flex ">
                <div
                    ...
                    <div className="flex flex-row gap-5 p-3">
                        <span className="text-white text-5xl font-extrabold">22K+</span>
                        <span className="text-base">Happy Customer with our services</span>
                    </div>
                    <div className="flex flex-row gap-5 p-3">
                        <span className="text-white text-5xl font-extrabold">520K+</span>
                        <span className="text-base">Happy Customer with our services</span>
                    </div>
                </div>
            ...
            <div>
                <div className="flex flex-row gap-20 mx-auto max-w-5xl text-start">
                    ...
                    <p className="mx-auto mt-5 sm:text-l/relaxed w-5/6">
                        Look for an agency with a proven track record of success in buying, selling, or
                        renting properties. You want an agency that has been in the industry for a while
                        and has experience
                    </p>
                </div>
            </div>
